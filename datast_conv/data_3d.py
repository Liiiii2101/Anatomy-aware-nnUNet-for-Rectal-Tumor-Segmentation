...
if __name__ == '__main__':
    ...
    tgt_path = '/data/groups/beets-tan/l.cai/cbim/cbim_Data/zuyd39'
    ...
    for name in name_list:#os.listdir('.'):
        ...
        ResampleCMRImage(img, lab, tgt_path, name, count, target_spacing=(0.7291666865348816,0.7291666865348816, 2.9999978065490724))#(1.5625, 1.5625, 5.0))
        count += 1
        print(name, 'done')
