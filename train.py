...
def train_net(net, args, ema_net=None, fold_idx=0):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if (epoch+1) % args.val_freq == 0:
            ...
            #print(dice_list_test, dice_list_test.mean(), ASD_list_test, len(dice_list_test))
...
def get_parser():
    ...
    parser.add_argument('--cp_path', type=str, default='/data/groups/beets-tan/l.cai/cbim/cbim_model/meformer/', help='checkpoint path')
    parser.add_argument('--log_path', type=str, default='/data/groups/beets-tan/l.cai/cbim/cbim_model/meformer/log/', help='log path')
